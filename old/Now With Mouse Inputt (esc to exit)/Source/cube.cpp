...
:   shader  ( "Source/Shaders/vert.vert", "Source/Shaders/frag.frag")
,   pos     ( vec )
{
...
void
Cube :: update  ( const glm::mat4& view, const glm::mat4& proj )
{
    draw ( view, proj );
}

void
Cube :: draw    ( const glm::mat4& view, const glm::mat4& proj )
{
    glBindVertexArray ( mVao );
    shader.useProgram();
